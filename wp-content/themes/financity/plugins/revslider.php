<?php
	...
	add_filter('revslider_getUsedFonts', 'financity_revslider_getUsedFonts');
	if( !function_exists('financity_revslider_getUsedFonts') ){
		function financity_revslider_getUsedFonts( $used_font ){
