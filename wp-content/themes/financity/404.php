 ...
 */
	...
	echo '<h1 class="financity-not-found-head" >' . esc_html__('404', 'financity') . '</h1>';
	echo '<h3 class="financity-not-found-title financity-content-font" >' . esc_html__('Page Not Found', 'financity') . '</h3>';
	echo '<div class="financity-not-found-caption" >' . esc_html__('Sorry, we couldn\'t find the page you\'re looking for.', 'financity') . '</div>';
